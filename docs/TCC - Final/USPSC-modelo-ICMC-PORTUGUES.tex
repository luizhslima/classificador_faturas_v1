...
\hypersetup{
	...
	pdfkeywords={Classificação de transações financeiras}{Processamento de linguagem natural}{Busca vetorial por similaridade}{Reconhecimento óptico de caracteres}{Agentes inteligentes},

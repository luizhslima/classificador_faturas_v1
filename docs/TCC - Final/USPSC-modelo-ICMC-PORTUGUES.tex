...
\hypersetup{
	...
	pdfkeywords={Classificação de transações financeiras}{Processamento de linguagem natural}{Geração aumentada por recuperação}{Reconhecimento óptico de caracteres}{Agentes inteligentes},

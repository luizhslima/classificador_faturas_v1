...
% Permite quebra de linha em hifens dentro de URLs (referencias com localizadores longos)
...
\usepackage{seqsplit}
% Nome longo do modelo de embeddings, com pontos de quebra de linha (sem inserir hifen)
\newcommand{\modelemb}{\texttt{paraphrase-\discretionary{}{}{}multilingual-\discretionary{}{}{}MiniLM-\discretionary{}{}{}L12-v2}}
% Caminhos e identificadores de codigo: quebra de linha apenas em separadores (/ _ . -), via pacote url
\usepackage{url}
...
\definecolor{codetext}{HTML}{ECEFF4} 
...
\hypersetup{
	...
	pdfkeywords={Classificação de transações financeiras}{Processamento de linguagem natural}{Busca vetorial por similaridade}{Extração de documentos com preservação de leiaute}{Agentes inteligentes},
...
% Epígrafe
% ---
% SUPRIMIDA (2026-09-13): a citação atribuída a Satya Nadella não pôde ser
% verificada contra uma fonte primária citável (busca não localizou o texto
% original; circula apenas em paráfrases de conteúdo motivacional secundário)
% e o modelo ICMC exige que a epígrafe conste na lista de referências.
% Elemento pré-textual opcional -- suprimido em vez de mantida uma atribuição
% não verificável. Conteúdo original preservado em USPSC-Epigrafe.tex caso
% uma fonte primária seja localizada futuramente.
...
\include{USPSC-TA-Textual/USPSC-CAPX-Trabalhos_Relacionados}

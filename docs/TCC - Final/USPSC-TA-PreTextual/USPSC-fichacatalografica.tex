	...
	\begin{tabular}{|p{0.9cm} p{8.7cm}|}
		\hline
		 ...
		 \imprimircutter & 
		  ...
		  & \\ 
		  & \hspace{0.4cm} Classificação de transações financeiras. Processamento de linguagem natural. Geração aumentada por recuperação. Reconhecimento óptico de caracteres. Agentes inteligentes. I. \imprimirorientadorficha.
		   II. Título. \\

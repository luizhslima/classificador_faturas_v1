	...
	\begin{tabular}{|p{0.9cm} p{8.7cm}|}
		\hline
		 ...
		 \imprimircutter & 
		  ...
		  & \\ 
		  & \hspace{0.4cm} Classificação de transações financeiras. Processamento de linguagem natural. Busca vetorial por similaridade. Extração de documentos com preservação de leiaute. Agentes inteligentes. I. \imprimirorientadorficha.
		   II. Título. \\

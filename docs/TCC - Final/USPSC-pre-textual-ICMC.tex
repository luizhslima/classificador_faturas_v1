...
\titleabstract{Solution for Credit Card Statement Extraction and Classification Using Artificial Intelligence Tools}
\tituloadic{Solution for Credit Card Statement Extraction and Classification Using Artificial Intelligence Tools}
\tituloresumo{SOLUÇÃO PARA EXTRAÇÃO E CLASSIFICAÇÃO EM FATURAS DE CARTÃO DE CRÉDITO UTILIZANDO FERRAMENTAS DE INTELIGÊNCIA ARTIFICIAL}
